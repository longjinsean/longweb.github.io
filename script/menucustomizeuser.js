...
function devicetypechange(){
	...
	*/
	...
	var CONFIG_WEB_NET_MANAGE_DISABLE = "0";
	...
	for(var s=0; s < paramstr.length; s++)
	{
	    ...
	    }else if(paramname == "areainfo")
	    {
	    	switch(paramval){
					...
					break;
					case 'hunan':
						CONFIG_WEB_NET_MANAGE_DISABLE = "1";
					break;
					case 'default':
					break;
				}
	...
	if(hgutype == "0")
		{
			...
			for(var i=0;i<Modules.length;i++)
			{
				switch(Modules[i].name){
					...
					case "Application": Modules[i].display = "0";break;
					case "Management": Modules[i].display = "1";break;
					case "diagnose": Modules[i].display = "0";break;
			...
			for(var i in Apppanels)
			{
				if(!Apppanels[i].length)
				{
					switch(Apppanels[i].name){
						/* diagnose */
						case "Dia_Diagnose": Apppanels[i].display = "0";break;
						/* Help */
				...
				for(var j=0;j<Apppanels[i].length;j++)
				{
					switch(Apppanels[i][j].name){
						...
						/* Network */
						case "Net_Network": Apppanels[i][j].display = "0";break;
						...
						break;
						case "Net_Management": 
						if(CONFIG_WEB_NET_MANAGE_DISABLE == "1")
						{
							Apppanels[i][j].display = "0";
						}
						else if(CONFIG_WEB_NET_MANAGE_DISABLE == "0")
						{
							Apppanels[i][j].display = "1";  
						}
						break;
						case "Net_QoS": Apppanels[i][j].display = "0";break;
						case "Net_NTP": Apppanels[i][j].display = "0";break;
						case "Net_Route": Apppanels[i][j].display = "0";break;
						case "Net_UsersLimit": Apppanels[i][j].display = "1";break;
						/* Secure */
						...
						/* Application */
						case "App_DDNS": Apppanels[i][j].display = "0";break;
						case "App_NAT": Apppanels[i][j].display = "0";break;
						case "App_UPnP": Apppanels[i][j].display = "0";break;
						case "App_Voice": 
							if(potsnumstr == "0")
							{
								Apppanels[i][j].display = "0";
						...
						break;
						case "App_IGMP": Apppanels[i][j].display = "0";break;
						...
						case "Mng_Log": Apppanels[i][j].display = "0";break;
						case "Mng_upgrade": Apppanels[i][j].display = "0";break;
						case "Mng_Maintain": Apppanels[i][j].display = "0";break;
						/* diagnose */
						case "Dia_Diagnose": Apppanels[i][j].display = "0";break;
			...
			for(var i in Applications)
			{
				if(!Applications[i].length)
				{
					switch(Applications[i].name){
						...
						case "SV_Voiceinfo": 
							if(potsnumstr == "0")
							{
								Applications[i].display = "0";
							}else
							{
								Applications[i].display = "1";
							}
						break;
						default:break;
					}
				...
				for(var j=0;j<Applications[i].length;j++)
				{
					switch(Applications[i][j].name){
						...
						/* Net_Management */
						case "NM_ITMS": Applications[i][j].display = "0";break;
						...
						case "AN_DMZ": Applications[i][j].display = "0";break;
						...
						/* Mng_User */
						case "MU_User": Applications[i][j].display = "0";break;
						/*MU_Useradmin*/
						case "MU_Useradmin": Applications[i][j].display = "1";break;
						/* Mng_Device */
						...
						/* MU_upgrade */
						case "MU_upgrade": Applications[i][j].display = "0";break;
						/* Mng_Maintain */
			...
			for(var i in Panels)
			{
				...
				for(var j=0;j<Panels[i].length;j++){
					...
					{
						//case "Title_pon": Panels[i][j].display = "0";break;
						case "Title_wifi": 
						if(wlannumstr == "0")
						{
						...
						for(var k=0;k<Panels[i][j].tags.length;k++)
					{
						...
						{
						case "domain_tip": Panels[i][j].tags[k].display = "0";break;
						case "Domain_text": Panels[i][j].tags[k].display = "0";break;
						case "Apply_button": Panels[i][j].tags[k].display = "0";break;
						...
						break;
						//case "MDdevice_infocontext": Panels[i][j].tags[k].display = "0";break;
						//case "RecEnable_checkbox": Panels[i][j].tags[k].display = "0";break;
						//case "Usbsubarea_select": Panels[i][j].tags[k].display = "0";break;
						/*case "MDdevice_button": 
							if(usbnumstr == "0")
							{
							Panels[i][j].tags[k].display = "0";
						...
						case "Table_pon1_Networklinks_list":
							if(CONFIG_WEB_USER_FEC == "1")
							{
								Panels[i][j].tags[k].display = "1";
							}else
							{
						...
						break; /*FEC*/
						case "Table_pon1_Networklinks_userlist": 
							if(CONFIG_WEB_USER_FEC == "1")
							{
								Panels[i][j].tags[k].display = "0";
							}else
						...
						break;
						case "Table_pon5_Performance_list": Panels[i][j].tags[k].display = "0";break;
						case "Table_pon5_Performance_userlist": 
							if(CONFIG_WEB_USER_ALERT == "1")
							{
								Panels[i][j].tags[k].display = "0";
							}else
							{
						...
						break;
						case "Table_pon5_Performance_userlist_hubei": 
							if(CONFIG_WEB_USER_ALERT == "1")
							{
								Panels[i][j].tags[k].display = "1";
							}else
						...
						//case "LanPhone6_checkbox": Panels[i][j].tags[k].display = "0";break;
						//case "LanCamera6_checkbox": Panels[i][j].tags[k].display = "0";break;
						case "factoryset_all_label": Panels[i][j].tags[k].display = "0";break;
						case "factoryset_all_tips_label": Panels[i][j].tags[k].display = "0";break;
						case "factoryset_all_button": Panels[i][j].tags[k].display = "0";break;
			...
			for(var i in Panels)
			{
				...
				for(var j=0;j<Panels[i].length;j++){
					...
					for(var k=0;k<Panels[i][j].tags.length;k++)
					{
						...
						//case "RecEnable_checkbox": Panels[i][j].tags[k].display = "0";break;
						//case "Usbsubarea_select": Panels[i][j].tags[k].display = "0";break;
						//case "MDdevice_button": Panels[i][j].tags[k].display = "0";break;
						case "usbEquipment_select": 
							if(usbnumstr == "0")
							{
							Panels[i][j].tags[k].display = "0";
						...
						//case "LanPhone6_checkbox": Panels[i][j].tags[k].display = "0";break;
						//case "LanCamera6_checkbox": Panels[i][j].tags[k].display = "0";break;
						case "Table_pon1_Networklinks_list": Panels[i][j].tags[k].display = "0";break; /*FEC*/
						case "Table_pon1_Networklinks_userlist": Panels[i][j].tags[k].display = "1";break;
						case "Table_pon5_Performance_list": Panels[i][j].tags[k].display = "0";break;
						case "Table_pon5_Performance_userlist": Panels[i][j].tags[k].display = "1";break;
